        ...
        <form method="post" action="Modal_Includes/Modal_Submit.php" class="form-horizontal" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<div class="form-group" id="name_box">
                        <label class="control-label col-lg-4" for="add_item_name">Price</label>
                        <div class="col-lg-8">
                            <input type="number" class="form-control" id="add_item_price" name="item_price" placeholder="Item price" maxlength="<?php echo Config::$max_lg_limit; ?>" required="required">
                        </div>
                    </div>
